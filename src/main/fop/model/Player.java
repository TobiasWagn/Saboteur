...
public class Player {
	...
	public List<BrokenToolCard> getBrokenTools(){
		return actionCards.stream().filter(ac -> ac.isBrokenTool()).map(ac -> (BrokenToolCard)ac).collect(Collectors.toList());
	}
